...
import { Mail, Phone, Instagram, Linkedin, Twitter, MessageCircle, Facebook } from 'lucide-react';
                    ...
                    >
                        <div className="mb-8">
                            ...
                            <p className="text-gray-400 text-lg">
                                Open for  coding and business roles. I'm always excited to discuss new projects and opportunities.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <ContactItem
                                icon={Mail}
                                label="Email"
                                value="ganeshbhojane777..."
                                href="mailto:ganeshbhojane992@gmail.com"
                            ...
                            <ContactItem
                                ...
                                label="Phone"
                                value="+91 9284955948"
                                href="tel:+919284955948"
                                color="text-neon-green"
                            />
                            <ContactItem
                                icon={Linkedin}
                                label="LinkedIn"
                                value="Ganesh-Bhojane"
                                href="http://www.linkedin.com/in/ganesh-bhojane-83b725286"
                            />
                            <ContactItem
                                icon={Facebook}
                                label="Facebook"
                                value="Ganesh-Bhojane"
                                href="https://www.facebook.com/profile.php?id=100076633045592"
                            />
                            <ContactItem
                                icon={Instagram}
                                label="Instagram"
                                value="@bhojane_777"
                                href="https://www.instagram.com/bhojane_777/"
                                color="text-pink-500"
                            />
                            <ContactItem
                                icon={MessageCircle}
                        ...
                        <div className="pt-4">
                            <p className="text-sm text-gray-500">
                                Based in Maharashtra , India (LPU)
                            </p>
                        </div>
                    </motion.div>
