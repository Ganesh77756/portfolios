        ...
        <footer className="bg-black/50 backdrop-blur-sm border-t border-white/5 py-8 mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
                <div className="mb-4 md:mb-0">
                    <p className="text-gray-400 text-sm">© 2027 Ganesh Bhojane. All rights reserved.</p>
                </div>
                <div className="flex space-x-6">
                    <SocialIcon Icon={Github} href="https://github.com/Ganesh77756" label="GitHub" />
                    <SocialIcon Icon={Linkedin} href="http://www.linkedin.com/in/ganesh-bhojane-83b725286" label="LinkedIn" />
                    <SocialIcon Icon={Facebook} href="https://www.facebook.com/profile.php?id=100076633045592" label="Twitter (not set)" />
                    <SocialIcon Icon={Instagram} href="https://www.instagram.com/bhojane_777/" label="Instagram" />
                </div>
            </div>
        </footer>
    );
