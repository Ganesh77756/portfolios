                ...
                >
                    ...
                    <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                        <p>
                            ...
                            student at Dr. D. Y. Patil Institute of Technology, Pimpri Pune (DIT),
                        ...
                        <p>
                            Leadership runs in my code. I enjoy building communities,
                            managing teams, and driving initiatives that create real impact
                        ...
                        <div className="pt-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {[
                                    ...
                                    <span
                                        key={skill}
                                        className="px-3 py-1 text-sm rounded-full bg-white/10 border border-white/5 hover:bg-white/20 transition-colors cursor-default"
                                    >
                                        {skill}
                                    </span>
                                ))}
